...
* @author zoltan
*/
public class hcButtonWithCountLabel_Chrome_Test extends hcButtonWithCountLabel_Test
{
	...
	public static void setUpBeforeClass() throws Exception
	{
        ...
        myLog2HTML = new Log2HTML("target/hcButtonWithCountLabel_Chrome_Test.html");
